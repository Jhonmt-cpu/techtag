...
class AppColors {
  ...
  static const Color linesInWhite = Color(0xFFE6E6F0);
  static const Color hover = Color(0xFFEBEBF5);
  static const Color background = Color(0xFFF0F0F7);

  static const Color shape01 = Color(0xFFFFFFFF);
  static const Color shape02 = Color(0xFFFAFAFC);
  static const Color disable = Color(0xFFDCDCE5);

  static const Color titles = Color(0xFF32264D);
  static const Color base = Color(0xFF6A6180);
  static const Color complements = Color(0xFF9C98A6);
